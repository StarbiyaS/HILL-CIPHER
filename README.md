...
decrypt the message, each block is multiplied by the inverse of the m trix used for encryption. The matrix used for encryption is the cipher key, and it shold be chosenrandomly from the set of invertible n × n matrices (modulo 26).
...
int main() {
  char msg[] = "STARBIYA", enc[100], dec[100];
...
<img width="1630" height="778" alt="image" src="https://github.com/user-attachments/assets/316f70a3-5328-4ff0-b76f-e9ce6d6981b4" />


## RESULT
Thus a C program to implement the hill cipher substitution techniques was executed successfully.
